...
def transcribe(audio_file: Path, method: str = "whisper", model: str = "base.en") -> dict:
    ...
    if method == "whisper":
        ...
        raise ValueError(f"Unsupported method: {method}. Only whisper is currently supported.")
